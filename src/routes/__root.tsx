...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Con Cariño PR connect — caregiving coordination" },
      { name: "description", content: "Con Cariño PR connect keeps caregivers, clients, and families on the same page — schedules, care plans, visit logs and messages in one warm, calm workspace." },
      { name: "author", content: "Con Cariño PR connect" },
