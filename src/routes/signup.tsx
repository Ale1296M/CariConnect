...
export const Route = createFileRoute("/signup")({
  ...
  head: () => ({
    meta: [
      { title: "Create your workspace · Con Cariño PR connect" },
      { name: "description", content: "Set up your Con Cariño PR connect caregiving workspace in three steps." },
      { property: "og:title", content: "Create your workspace · Con Cariño PR connect" },
