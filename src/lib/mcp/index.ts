...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for the Con Cariño PR connect caregiving coordination app. Read care recipients, shifts, care plan items, and visit logs, and send messages to the care team. All access is scoped to the signed-in user's permissions.",
